...
public static class SequentialWorkflow
{
    public static void AddSequentialWorkflow(this IHostApplicationBuilder builder)
    {
        builder.AddAIAgent("sequential-newsdesk-reporter", """
            You are a news reporter. Write a concise news article (250 words) about the given topic.
        ...
        builder.AddAIAgent("sequential-newsdesk-factchecker", """
            You are a fact-checker. Review the article for accuracy, flag any unsupported claims,
            and add [VERIFIED] or [NEEDS SOURCE] annotations. Suggest corrections where needed.
            """);
        builder.AddAIAgent("sequential-newsdesk-editor", """
            You are a senior editor. Polish the article for clarity and flow.
            Ensure the headline is compelling. Format the final version ready for publication.
            """);
