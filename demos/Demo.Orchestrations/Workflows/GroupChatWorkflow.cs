...
public static class GroupChatWorkflow
{
    public static void AddGroupChatWorkflow(this IHostApplicationBuilder builder)
    {
        ...
        builder.AddAIAgent("groupchat-startup-founder", (sp, key) => new ChatClientAgent(
            ...
            instructions: """
                ...
                You can use lookup_market_data to back up claims with real numbers.
        ...
        builder.AddAIAgent("groupchat-startup-investor", (sp, key) => new ChatClientAgent(
            sp.GetRequiredService<IChatClient>(),
            name: key,
            ...
            instructions: """
                ...
                Use estimate_unit_economics and search_competitors to challenge claims with data.
        ...
        builder.AddAIAgent("groupchat-startup-advisor", (sp, key) => new ChatClientAgent(
            sp.GetRequiredService<IChatClient>(),
            name: key,
            ...
            instructions: """
                ...
                You can use lookup_market_data to ground recommendations in data.
